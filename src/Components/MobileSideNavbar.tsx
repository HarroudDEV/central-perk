      ...
      >
        <Toolbar>
          <IconButton
            ...
            aria-label="menu"
            sx={{ mr: 2 }}
            onClick={toggleDrawer(true)} // Open drawer on menu click
          >
            <MenuIcon />
          </IconButton>
          <Typography
            variant="h6"
            component="div"
            sx={{ flexGrow: 1, color: "rgb(255, 244, 228)" }}
          >
            Photos
          </Typography>
          <div>
        ...
        >
          <Box
            sx={{ width: 250, background: "#FFF4E4", height: "100%" }}
            role="presentation"
            onClick={toggleDrawer(false)} // Close drawer when clicked inside
            onKeyDown={toggleDrawer(false)} // Handle keyboard interactions
          >
            <List>
              <ListItem disablePadding>
                <ListItemButton component={Link} to="/Dashboard">
                  <ListItemText primary="Dashboard" sx={{ color: "#434D55" }} />
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton component={Link} to="/Rewards">
                  <ListItemText primary="Rewards" sx={{ color: "#434D55" }} />
                </ListItemButton>
              </ListItem>
            </List>
          </Box>
